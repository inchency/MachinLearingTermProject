...
PACKER_PATH = "C:\\Users\\jack\\Desktop\\autopackingscript\\tools\\upx394w\\"
MAL_PATH = "C:\\Users\\jack\\Desktop\\노패킹exe"
OUT_PATH = "C:\\Users\\jack\\Desktop\\패킹아웃풋\\upx394w"
...
for x in malfile_list:
    ...
    command = '{upx_path}upx.exe {file}'.format(upx_path = PACKER_PATH, file = to_mal_path)
    subprocess.run(command, shell=True)
